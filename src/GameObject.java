...
public abstract class GameObject {
	...
	// Keep the object in the bounds of the field
	public void clip() {
		if (x < 0)
			x = 0;
	...
	/**
	 * Manage what happens when the object is hit by a bullet,
	 * and return how many points (if any) should be awarded.
	 * Optional operation - throws UnsupportedOperationException if
	 * not available.
	 * @param bullets The bullets that this object should be checked for.
	 * @return An int consisting of this GameObject's point yield.
	 */
	public abstract int bulletContact(Bullet... bullets);
}
